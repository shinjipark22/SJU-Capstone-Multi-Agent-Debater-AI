...
- 2개의 핵심 논거로 구성
- 각 논거에 반드시 참고 자료에 있는 구체적 수치/기관명/사례를 1개 이상 인용할 것 (예: "WEF에 따르면 2030년까지 7800만개")
- 다음 표현은 절대 사용 금지: "보고서에 따르면", "연구에 따르면", "연구 보고서에 따르면", "에 따르면" 단독 사용. 반드시 "MIT 연구진에 따르면", "KDI 보고서에 따르면"처럼 기관/연구자명을 명시할 것
- 참고 자료에 없는 수치나 통계를 지어내지 마라. 참고 자료에 있는 내용만 인용할 것
- 영어 인명은 한글로 표기할 것 (예: Jerome Powell → 제롬 파월)
- 각 논거는 3줄 이내
- 결론에서 {stance_kr} 입장 재확인
- 반드시 한국어만 사용 (영어, 한자, 일본어 금지)
- 블로그, 커뮤니티, 네이버, Daum 출처 인용 금지. 공신력 있는 기관(WEF, OECD, ILO, KDI, MIT 등)만 인용
