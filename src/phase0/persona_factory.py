...
def _build_system_prompt(
    ...
    prompt = f"""[언어 절대 원칙 — 이 규칙이 모든 것보다 최우선입니다]
반드시 100% 자연스러운 한국어로만 출력하세요. 중국어 한자(간체·번체), 일본어, 폴란드어 등 한국어가 아닌 문자를 단 한 글자도 절대 섞어 쓰지 마세요. 고유명사(IMF, WEF 등 영문 기관명)만 예외입니다.
...
[말투]
반드시 "~입니다", "~습니다" 체(합쇼체)로만 말하라. "~이다", "~한다", "~이야" 같은 다른 말투는 절대 쓰지 마라.
