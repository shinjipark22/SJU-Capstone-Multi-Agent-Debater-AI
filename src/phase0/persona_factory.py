...
[언어 절대 원칙]
반드시 100% 자연스러운 한국어(Korean)로만 출력하세요. 고유명사(기관명 등)를 제외하고 영어, 중국어(간체/번체) 등 다른 언어의 알파벳은 단 한 글자도 절대 섞어 쓰지 마세요.
...
[스타일]
'존경하는 심판관 여러분', '상대방 여러분' 같은 기계적 인사말은 절대 하지 마세요. 인사나 서론 없이 첫 문장부터 곧바로 핵심 주장과 근거로 치고 들어가세요. ~입니다/~습니다 합쇼체로만 말하세요."""
    return prompt.strip()
