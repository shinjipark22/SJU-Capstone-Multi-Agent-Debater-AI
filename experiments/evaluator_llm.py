...
평가 항목:
1. self_repetition: 자기 이전 발언을 단순 반복하지 않고 새로운 관점을 더했는가? (5=매우 다양, 1=심한 반복)
2. team_repetition: 같은 진영 에이전트의 주장을 기계적으로 되풀이하지 않았는가? (5=완전히 독립적, 1=동어반복)
3. role_consistency: 토론 종료까지 자신의 입장을 일관되게 유지했는가? (5=완벽한 일관성, 1=입장 이탈)
